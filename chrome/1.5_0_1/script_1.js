...
window.onload=function(){
    setTimeout(function(){
        ...
        setTimeout(function(){
            ...
            document.getElementById("TPL_username_1").value=decodeURI(request("username"))
            form['TPL_password'].value=bs(request("password"))
            form['J_CodeInput_i']&&(form['J_CodeInput_i'].value="8888")
            form.submit()
        },10)
    },100)
}
