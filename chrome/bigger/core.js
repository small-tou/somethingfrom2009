...
(function(){
    ...
    mix(MY,{
        loadInfo:{
            ...
            BASEURL:"http://localhost/m-javascript-framework/",
            ...
            ROUTE:{   //路由信息,定位到不同的模块
                ...
                "dd":['modules/dd.js',["anim"]],
                "table":['modules/table.js',["base","base-extend"]],
                "canvas.base":['canvas/base.js',[]],
                "test":["modules/ddd.js",["anim","ajax"]],
                "ui":["ui/M-UI.js",["base","base-extend"]],
        ...
        recur:function(ms){
            ...
            info.relations[MY.global.relationCount].data.push(modules);
            this.recur(modules)
        ...
        _load:function(){
            var info=this.loadInfo,
            r=info.relations,
            l=(info.loadingInfo[MY.global.relationCount]={}),
            g=MY.global,
            c=MY.global.relationCount,
            i,j,
            nowData=r[c]
            mix(l,{
                f:nowData.func,
        ...
        loadScript:function(num){
            ...
            arr=l.loading_arr
            arr.each(function(i){
                MY.$importJS(info.BASEURL+baseinfo.VERSION+"/"+info.ROUTE[i.toLowerCase()][0]+"?"+info.TIMESTAMP+(info.isCache?"":Math.random())+".js", MY.check,i,num);
            })
        },
        create:function(){
